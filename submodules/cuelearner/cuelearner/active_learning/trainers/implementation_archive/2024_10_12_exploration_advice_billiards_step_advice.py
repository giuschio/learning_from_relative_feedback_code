...
# moved here after I unified exploration advice with navigation
# (i.e. choosing whether to give advice or not at the level of the episode
#   and not at the level of the step)
class Trainer:
    def __init__(
        self,
        # training args
