    ...
    def fit(self, policy, advice_cloner, train_env, val_env, expert):
        ...
        for step in range(1, self.max_steps):
            ...
            if step > self.start_steps:
                if self.__rng.uniform(0, 1) < self.advice_probability:
                    action = advice_cloner.select_action(
                        state=state, action=policy_action
                    )
                else:
            ...
            # GIVEN THE OPTIMAL ACTION, CALCULATE THE ADVICE
            improved_action = compute_advice(
                action, optimal_action, advice_cloner.advice_step_size
            )
            # ---- ADVICE END
            ...
            # if step > 2000: scheduler_adv_training.update_every = 100
            ...
            # used for billiards adaptation
            # if step > 500:
            #     scheduler_adv_training.update_every = 20
