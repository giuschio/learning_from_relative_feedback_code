        ...
        for step in range(1, self.max_steps, num_envs):
            ...
            if step < self.start_steps:
                ...
                for index in range(num_envs):
                    ...
                    # compare the action to the advised action, give an augmented reward if
                    # close to the correct one, otherwise 0
                    action_error = angle(advised_action, action[index])
                    if action_error < 20.:
                        augmented_reward[index] = 1.0
                        advices_used += 1
            ...
            for index in range(num_envs):
                reward[index] += augmented_reward[index]
            ...
            for index in range(num_envs):
                if done[index]:
                    ...
                    and (step < self.advice_label_limit))
                    use_advice[index] = ua
