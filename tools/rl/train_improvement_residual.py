"""
Train a residual policy from corrections
"""
...
from cuelearner.active_learning.trainers.improvement_residual import Trainer
...
def main(config):
    ...
    advice_cloner.advice_max_steps = 1
...
if __name__ == "__main__":
    ...
    default_config = "configs_exp/2024_05_31_adaptation_friction/residual_long.yaml"
